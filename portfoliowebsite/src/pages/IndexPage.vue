<template>
  <div class="padding-x__5perc">
    <q-header>
      <q-toolbar
        :class="{ 'bg-dark font-white': isDarkMode }"
        class="text-black"
      >
        <q-toolbar>
          <q-toolbar-title
    ...
    <q-page padding>
      <!-- TITLE: GREETINGS -->
      <div id="greetings" class="q-pt-xl">
        <div class="row">
          <div
            :class="{ 'items-center col-12': APP_BREAKPOINTS.breakpoint }"
            class="col-7 column justify-center q-py-md"
          >
            ...
            <div
              class="full-width"
              :class="{ 'flex flex-center': APP_BREAKPOINTS.breakpoint }"
            >
      ...
      <div id="profession">
        <div class="row q-mt-xl">
          ...
          <div
            ...
            class="col-6 q-py-md column justify-center items-center"
          >
            <div>
              ...
              <div class="custom-text">
                ...
                <div class="column">
                  ...
                  >
                    <q-icon
                      :color="
                        APP_CONSTANTS.profession.skills.skillIcon.iconColor
                      "
        ...
        <div class="column text-weight-thin custom-text">
          ...
          >
            ...
            <q-slider
              ...
              :inner-track-color="
                APP_CONSTANTS.proficiecy.skills.innerTrackColor
              "
      ...
      >
        ...
        <div class="row">
          <div
            ...
            class="col-12 col-sm-6 col-md-3 q-px-sm q-py-md"
          >
            <q-card class="full-height border-radius__16px" bordered>
              <q-card-section
        ...
        <div class="row custom-text">
          ...
          >
            <div class="q-mb-xs">
              ...
              <div class="q-mt-sm q-pl-md">Open for opportunities: Yes</div>
            </div>
            <div class="q-pl-md">
